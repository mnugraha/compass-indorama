...
@section('judul')
    <span class="label label-warning label-bordered" style="font-size: 18px; color:black">
...
@section('konten-tanpa-frame')
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingOne">
                        ...
                        <div class="panel-elements pull-right">
                            <span class="label label-warning">C1</span>
                        </div>
                    </div>
    ...
    <a href="/C" class="btn btn-default btn-icon-fixed"><span class="icon-arrow-left"></span> Kembali</a>
    <br>
    <br>
@endsection
